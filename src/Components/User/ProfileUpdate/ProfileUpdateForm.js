    ...
    return (
        <div className='ProfileUpdateForm'>
                    ...
                    {(open == 'aim')
                        ...
                        <div className='update__form__row update__open'>
                            ...
                            <div className='right__upd'>
                                ...
                                }} placeholder='Tell us about yourself (interests, experience, etc.)' defaultValue={member?.aim} />
                                <div className='update__buttons'>
                                    <button onClick={(e) => {
                                        dispatch(updateMember({
                                            aim: aim
                    ...
                    {(open == 'lkd')
                        ...
                        <div className='update__form__row update__open'>
                            ...
                            <div className='right__upd'>
                                ...
                                }} type={'text'} defaultValue={member?.linkedin} placeholder='LinkedIn profile link' />
                                <div className='update__buttons'>
                                    <button onClick={(e) => {
                                        dispatch(updateMember({
                                            linkedin: lkd,
                        ...
                        <div className='update__form__row'>
                            <div className='col1'>
                                <div className='left__upd'>LinkedIn Profile</div>
                                <div className='right__upd'><a target={'_blank'} href={member?.linkedin}>{member?.linkedin}</a></div>
                    ...
                    {(open == 'git')
                        ...
                        <div className='update__form__row update__open'>
                            ...
                            <div className='right__upd'>
                                ...
                                }} type={'text'} placeholder='Github profile link' defaultValue={member?.github} />
                                <div className='update__buttons'>
                                    <button onClick={(e) => {
                                        dispatch(updateMember({
                                            github: git,
                        ...
                        <div className='update__form__row'>
                            <div className='col1'>
                                <div className='left__upd'>Github Profile</div>
                                <div className='right__upd'><a target={'_blank'} href={member?.github}>{member?.github}</a></div>
                    ...
                    {(open == 'ltc')
                        ...
                        <div className='update__form__row update__open'>
                            ...
                            <div className='right__upd'>
                                ...
                                }} type={'text'} placeholder='Leetcode profile link' value={member?.leetcode && member?.leetcode} />
                                <div className='update__buttons'>
                                    <button onClick={(e) => {
                                        dispatch(updateMember({
                                            leetcode: ltc
                        ...
                        <div className='update__form__row'>
                            <div className='col1'>
                                <div className='left__upd'>Leetcode Profile</div>
                                <div className='right__upd'>{member?.leetcode ? <a target={'_blank'} href={member?.leetcode}>{member?.leetcode}</a> : '🤷'}</div>
                    ...
                    {(open == 'cc')
                        ...
                        <div className='update__form__row update__open'>
                            ...
                            <div className='right__upd'>
                                ...
                                }} type={'text'} placeholder='Codechef profile link' value={member?.codechef && member?.codechef} />
                                <div className='update__buttons'>
                                    <button onClick={(e) => {
                                        dispatch(updateMember({
                                            codechef: cc
                        ...
                        <div className='update__form__row'>
                            <div className='col1'>
                                <div className='left__upd'>Codechef Profile</div>
                                <div className='right__upd'>{member?.codechef ? <a target={'_blank'} href={member?.codechef}>{member?.codechef}</a> : '🤷'}</div>
                    ...
                    {(open == 'cf')
                        ...
                        <div className='update__form__row update__open'>
                            ...
                            <div className='right__upd'>
                                ...
                                }} type={'text'} placeholder='Codeforces profile link' defaultValue={member?.codeforces ? member?.codeforces : undefined} />
                                <div className='update__buttons'>
                                    <button onClick={(e) => {
                                        dispatch(updateMember({
                                            codeforces: cf,
                        ...
                        <div className='update__form__row'>
                            <div className='col1'>
                                <div className='left__upd'>Codeforces Profile</div>
                                <div className='right__upd'>{member?.codeforces ? <a target={'_blank'} href={member?.codeforces}>{member?.codeforces}</a> : '🤷'}</div>
                    ...
                    {(open == 'web')
                        ...
                        <div className='update__form__row update__open'>
                            ...
                            <div className='right__upd'>
                                ...
                                }} type={'text'} placeholder='Your blog, portfolio, etc.' defaultValue={member?.web && member?.web} />
                                <div className='update__buttons'>
                                    <button onClick={(e) => {
                                        dispatch(updateMember({
                                            web: web,
                        ...
                        <div className='update__form__row'>
                            <div className='col1'>
                                <div className='left__upd'>Website</div>
                                <div className='right__upd'>{member?.web ? <a target={'_blank'} href={member?.web}>{member?.web}</a> : '🤷'}</div>
            ...
            <div className='button__wrapper'>
                <button className={(globalchange) ? '' : 'nochange'} onClick={globalchange ? updateProfile : undefined}>Update</button>
            </div>
        </div >
    )
}
