	...
	return (
		<div className="ContestScreen">
			<>
				<div className="landing__page__header">
					...
					<div className="inner">
						<div className="landing__nav">
							...
							<div
								onClick={() => dispatch(brgrOpen(!brgrMenu))}
								className="landing__nav__list__item hms__brgr__open"
							>
								Menu
							</div>
						</div>
				...
				<div
					className={brgrMenu ? 'brgr__wrapper open__brgr' : 'brgr__wrapper'}
				>
					...
					<div className="brgr__item">
						<Link to={user ? '/explore' : '/home'} className="option__link">
							Explore
						</Link>
					</div>
					<div className="brgr__item">
						<Link to="/contests" className="option__link">
							Contests
						</Link>
					</div>
					<div className="brgr__item">
						<Link to="/team" className="option__link">
							Team
						</Link>
					</div>
					<div className="brgr__item">
						<Link to="/projects" className="option__link">
							Projects
						</Link>
					</div>
					<div className="brgr__item">
						<Link to="/alumni" className="option__link">
							Alumni
						</Link>
					</div>
					<div className="brgr__item">
						<Link to="/privacy" className="option__link">
							Privacy Policy
						</Link>
					</div>
					{user ? (
								...
								({ name, link, start_time, duration, status }, i) => {
									return (
										<div key={link + i} className="list__row">
											...
											<span className="grid__item">{parse(duration)}</span>
											{status === 'CODING' ? (
												<span
